...
export default class GameState {
  ...
  _initState() {
    ...
    this.usedIndices      = {}
    this.undoStack        = []
    this.sections.forEach(s => { this.usedIndices[s] = new Set() })
  }
  ...
  skipQuestion() {
    this._validate(this.currentQuestion, 'No active question')
    this._validate(this.questionState !== 'scoring', 'Finish the current attempt before skipping')
  ...
  resetQuestion() {
    ...
    this._validate(this.questionState !== 'scoring', 'Finish the current attempt before resetting')
    this._pushUndo()
